...
class AnswerEvaluator:
    def __init__(self):
        ...
        self.evaluation_prompt = ChatPromptTemplate.from_template(
            """As an expert educator, evaluate this answer based on the question:
            if the answer is diiferent from the question what asked to do then see the answer and provide marks with proper justification and missing elements
            ...
            **Student Answer**: {answer}
            ...
            if actual length of the context is more than or nearer to expected length then it's good
...
@shared_task
def evaluate_answer_task(question_type, topic, difficulty, marks, question, answer):
